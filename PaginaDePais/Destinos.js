const Destinos = {
    ...
    EmiratosArabes: {
        ...
        Bandera: '../ImagenesDestinos/EmiratosArabes/BanderaEmiratosArabes.jpg',
        Dubai: {
            Nombre: 'Dubai',
        ...
        AbuDhabi: {
            Nombre: 'Abu Dhabi',
            Imagen: 'url("../ImagenesDestinos/EmiratosArabes/AbuDhabi.jpg")',
        ...
        Sharjah: {
            Nombre: 'Sharjah',
            Imagen: 'url("../ImagenesDestinos/EmiratosArabes/Sharjah.jpg")',
        ...
        Ajman: {
            Nombre: 'Ajman',
            Imagen: 'url("../ImagenesDestinos/EmiratosArabes/Ajman.jpg")',
        ...
        RasAIKhaimah: {
            ...
            Imagen: 'url("../ImagenesDestinos/EmiratosArabes/RasAIKhaimah.jpg")',
        ...
        Fujairah: {
            Nombre: 'Fujairah',
            Imagen: 'url("../ImagenesDestinos/EmiratosArabes/Fujairah.jpg")',
